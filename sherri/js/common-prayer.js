...
//	$("#notification-list-display").addClass("is-active");
  ...
  return check;
    ...
    god.getLocalDateTime = function(dateString) {
	...
	const dateStringString = `${month} ${day}, ${year}`;

	// Construct the time string in 12-hour format with AM/PM
	const timeString = `${hours12}:${formattedMinutes} ${meridiem}`;

	// Return combined date and time string
	//return `${dateStringString} ${timeString}`;
